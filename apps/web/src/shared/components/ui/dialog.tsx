...
const DialogHeader = (props: React.HTMLAttributes<HTMLDivElement>): React.ReactElement => {
...
const DialogFooter = (props: React.HTMLAttributes<HTMLDivElement>): React.ReactElement => {
  const { className, ...rest } = props;
